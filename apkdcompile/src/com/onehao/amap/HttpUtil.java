...
public class HttpUtil {
	...
	public static void main(String[] args) throws IOException {
		...
		String fileUrl = "http://android-apps.25pp.com//fs03/2015/11/02/1/1_5b4ad380ad61fad8cdad5867e95f0684.apk";
		downloadFile(String.format("E:\\apks\\%s",fileUrl.substring(fileUrl.lastIndexOf("/"))),
				fileUrl);
	}
}
